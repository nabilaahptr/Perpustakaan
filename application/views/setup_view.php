                ...
                <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box">
                    <form role="form" action="<?php echo base_url() ?>setup/submit" method="post" class="f1">
                        ...
                        <fieldset>
                            ...
                            <p>
                                &emsp;Saya ucapkan terima kasih yang sebesar besarnya
                                karena telah mempercayakan aplikasi website ini
                                kepada saya. Silahkan memulai dengan mengisi
                                data perpustakaan anda. Selamat Menggunakan.
                            </p>
